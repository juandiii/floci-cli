...
public class AzStatusCommand implements Callable<Integer> {
    ...
    public Integer call() {
        ...
        printer.println(Ansi.bold("Floci Azure Status"));
        printer.println("");
        ...
        if (!reachable && !"running".equals(containerState)) {
            printer.println("");
            printer.println(Ansi.gray("Run 'floci az start' to launch Floci Azure."));
        }
